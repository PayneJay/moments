...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = Constants.sApplication.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = Constants.sApplication.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
